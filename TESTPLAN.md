...
| TC-5.1       | Credit Amount then Debit then check                 | Application started  | 1. Start the application. <br> 2. Select option 2 to credit the account. <br> 3. Enter 200.00 as the credit amount. <br> 4. Select option 3 to debit the account. <br> 5. Enter 150.00 as the debit amount. <br> 6. Select option 1 to display the current balance.   | The application should display the same balance as before.                     |               |                    |          |
